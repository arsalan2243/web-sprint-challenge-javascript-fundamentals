...
// when we define a function within another function the inner function can access the variable within the outer function. (this is where the closure happens and this is called lexical scope function)
// we can see that internal variable is defind out side of nested function and the nested function can acces it 
...
// console.log(animalNames(zooAnimals))
  ...
  */
  ...
  function USApop(array){
    const totalPopulation =  array.reduce(accumulator, item => accumulator + item.population,0);
